...
{
    public static class SimplexNoise // Simplex noise in 1D, 2D, 3D and 4D
    {
        public static float Simplex(float input)
        {
            return (float)SimplexNoise.noise(input,-1.76);
        }

        public static float Simplex(float input, float scalar)
        {
            return (float)SimplexNoise.noise(input, scalar);
        }
        
        public static float Simplex(double input)
        {
            return (float)SimplexNoise.noise(input,-1.76);
        }

        public static float Simplex(double input, double scalar)
        {
            return (float)SimplexNoise.noise(input, scalar);
        }
        
        public static float Simplex(Vector2 input)
        {
            return (float)SimplexNoise.noise(input.X, input.Y);
        }

        public static float Simplex(Vector2 input, float scalar)
        {
            return (float)SimplexNoise.noise(input.X, input.Y, scalar);
        }
        
        public static float Simplex(Vector3 input)
        {
            return (float)SimplexNoise.noise(input.X, input.Y, input.Z);
        }

        public static float Simplex(Vector3 input, float scalar)
        {
            return (float)SimplexNoise.noise(input.X, input.Y, input.Z, scalar);
        }
        
        public static float Simplex(Vector4 input)
        {
            return (float)SimplexNoise.noise(input.X, input.Y, input.Z, input.W);
        }
        ...
        // 1D simplex noise
        public static double noise(double input)
        {
            int i0 = fastfloor(input);
            int i1 = i0 + 1;
            double x0 = input - i0;
            double x1 = x0 - 1.0f;
...
//            n0 = t0 * t0 * perm[i0 & 0xff]* x0;

            double t1 = 1.0f - x1*x1;
            t1 *= t1;
            n1 = t1 * t1 * grad(perm[i1 & 0xff], x1);

//            n1 = t1 * t1 * perm[i1 & 0xff]* x1;
