...
namespace VL.ImGui.Widgets
{
    ...
    internal partial class InputVector3 : ChannelWidget<Vector3>, IHasInputTextFlags
    {
        /// <summary>
        ...
        {
            var value = Update();
            if (ImGuiUtils.InputFloat3(widgetLabel.Update(label.Value), ref value, string.IsNullOrWhiteSpace(Format) ? null : Format, Flags))
