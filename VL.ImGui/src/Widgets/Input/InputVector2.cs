...
namespace VL.ImGui.Widgets
{
    ...
    internal partial class InputVector2 : ChannelWidget<Vector2>
    {
        ...
        System.Numerics.Vector2 lastframeValue;

        internal override void UpdateCore(Context context)
        {
            var value = Update().ToImGui();
            if (ImGuiNET.ImGui.InputFloat2(Context.GetLabel(this, Label), ref value, string.IsNullOrWhiteSpace(Format) ? null : Format, Flags) && value != lastframeValue)
                Value = value.ToVL();
