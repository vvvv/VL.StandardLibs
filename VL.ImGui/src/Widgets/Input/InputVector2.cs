...
namespace VL.ImGui.Widgets
{
    ...
    internal partial class InputVector2 : ChannelWidget<Vector2>, IHasInputTextFlags
    {
        /// <summary>
        ...
        {
            var value = Update();
            if (ImGuiUtils.InputFloat2(widgetLabel.Update(label.Value), ref value, string.IsNullOrWhiteSpace(Format) ? null : Format, Flags))
