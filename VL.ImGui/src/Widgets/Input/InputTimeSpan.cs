...
namespace VL.ImGui.Widgets
{
    ...
    internal partial class InputTimeSpan : ChannelWidget<TimeSpan>, IHasInputTextFlags
    {
        ...
        internal override void UpdateCore(Context context)
        {
            ...
            if (ImGuiUtils.InputDouble(widgetLabel.Update(label.Value), ref seconds, Step, StepFast, string.IsNullOrWhiteSpace(Format) ? null : Format, Flags))
                SetValueIfChanged(lastframeValue, value = TimeSpan.FromSeconds(seconds), Flags);
