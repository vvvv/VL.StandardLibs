...
namespace VL.Video.MF
{
    ...
    {
        public unsafe static MFVideoCaptureImpl? Create(VideoCaptureConfig config, IntPtr device, bool useLinearColorspace, bool useLinearTextureFormat)
        {
            ...
            try
            {
                ...
                var sourceReader = SourceReader.CreateFromMediaSource(mediaSource, (ID3D11Device*)device, readAsync: true, useLinearColorspace, useLinearTextureFormat);
