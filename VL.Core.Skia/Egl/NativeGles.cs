...
{
	public static class NativeGles
	{
		...
		[DllImport(libGLESv2)]
		public static extern void glGenTextures(int n, ref uint texture);
		[DllImport(libGLESv2)]
		...
		[DllImport(libGLESv2)]
		public static extern void glDeleteTextures(int n, ref uint framebuffer);
		[DllImport(libGLESv2)]
		...
		[DllImport(libGLESv2)]
		public static extern void glEGLImageTargetTexture2DOES(int target, IntPtr buffer);
	}
}
