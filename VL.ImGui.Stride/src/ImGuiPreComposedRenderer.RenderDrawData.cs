...
namespace VL.ImGui
{
    partial class ImGuiPreComposedRenderer
    {
                ...
                for (int i = 0; i < cmdList.CmdBuffer.Size; i++)
                {
                        ...
                        if (renderLayer != null)
                        {
                            if (renderLayer.Viewport != null && context != null)
                            {
                                ...
                                using (renderContext.SaveViewportAndRestore())
                                {
                                    ...
                                    if (layer != null)
                                    {
                                        if (layer is ImGuiPreComposedRenderer renderer)
                                        {
                    ...
                    else
                    {
                        ...
                        if (tex != null)
                        {
                            ...
                            imShader.Parameters.Set(ImGuiPreComposedEffectShaderKeys.proj, ref projMatrix);
                            imShader.Parameters.Set(ImGuiPreComposedEffectShaderKeys.PreComposedTexture, preComposedTexture);
