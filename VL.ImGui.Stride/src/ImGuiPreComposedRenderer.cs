...
namespace VL.ImGui
{
    ...
    public partial class ImGuiPreComposedRenderer : RendererBase, IDisposable
    {
        ...
        private Texture preComposedTexture;

        public unsafe ImGuiPreComposedRenderer(NodeContext nodeContext)
        {
            ...
            compilerParameters.Set(ImGuiPreComposedEffectShaderKeys.ColorIsSRgb, device.ColorSpace == ColorSpace.Linear);
            imShader = new EffectInstance(effectSystem.LoadEffect("ImGuiPreComposedEffect", compilerParameters).WaitForResult());
        ...
        public void Update(Widget? widget, bool dockingEnabled, Spread<FontConfig?> fonts, bool fullscreenWindow, IStyle style, Texture preComposedTexture)
        {
            this.widget = widget;
            this.dockingEnabled = dockingEnabled;
            this.preComposedTexture = preComposedTexture;
